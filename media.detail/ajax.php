...
class formHandler
{
    ...
    private function handlerAjaxImg()
    {
    ...
    private function handlerAjaxElement()
    {
        if (isset($_POST['name']) && (isset($_POST['text']) && strlen($_POST['text']) >= 10)) {
            ...
            $el->Add(array(
                ...
                "NAME" => $_POST['name'],
                "PREVIEW_TEXT" => 'text',
                "CODE" => $this->chechCode($this->translit_sef($_POST['name'])),
                //"CODE" => $code,
        ...
        } elseif (isset($_POST['text']) && strlen($_POST['text']) < 10) {
